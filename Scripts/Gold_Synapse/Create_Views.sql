...
FROM 
    OPENROWSET
        (
            BULK 'https://awstoragedatalaksh.dfs.core.windows.net/silver/AdventureWorks_Customers/',
            FORMAT = 'PARQUET'
        ) as QUER1
...
FROM 
    OPENROWSET
        (
            BULK 'https://awstoragedatalakesh.dfs.core.windows.net/silver/AdventureWorks_SUbCategories/',
            FORMAT = 'PARQUET'
        ) as QUER1
